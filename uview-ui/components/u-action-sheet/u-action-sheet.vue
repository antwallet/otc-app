						...
						<!-- #endif -->
							<view class="u-action-sheet__item-wrap__item" @tap.stop="selectHandler(index)"
								...
								<template v-if="!item.loading">
									<view style="display: flex;align-items: center;flex-direction:initial;">
										<image src="../../../static/icon/USDT.png" mode=""
											style="width: 50rpx;height: 50rpx;" v-if="item.name=='USDT'"></image>
											<image src="../../../static/icon/TRX.png" mode=""
												style="width: 50rpx;height: 50rpx;" v-if="item.name=='TRX'"></image>
