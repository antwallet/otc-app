<template>
	<view class="u-code-input" style="align-items: center;padding-left: 50rpx;">
		...
		<input :disabled="disabledKeyboard" type="text" pattern="[A-Za-z0-9]+" :focus="focus" :value="inputValue"
			:maxlength="maxlength" :adjustPosition="adjustPosition" class="u-code-input__input" @input="inputHandler"
			:style="{
				height: $u.addUnit(size) 
			}" @blur="isFocus = false" />
		<image src="https://packet-gift.oss-ap-southeast-1.aliyuncs.com/2024/antwalletbotApp/images/hide.png" v-if="dot" @click="showSy(false)" class="xianying" mode=""></image>
		<image src="https://packet-gift.oss-ap-southeast-1.aliyuncs.com/2024/antwalletbotApp/images/browse.png" v-else @click="showSy(true)" class="xianying" mode=""></image>
	</view>
</template>
