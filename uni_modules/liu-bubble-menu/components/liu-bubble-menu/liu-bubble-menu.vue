<template>
	<view class="select-main">
		...
		<view class="card-main" v-show="show">
			<view class="card-item" :style="{top:top+'rpx',left:wzleft+'rpx',right:wzright+'rpx'}">
				<view class="arrow"
					:style="{background:bgColor,left:'40rpx',marginTop:'-10rpx',top: showTop && (arrowTop+12)+'rpx'}">
				</view>
